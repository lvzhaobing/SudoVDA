...
static const struct SampleMonitorMode s_SampleDefaultModes[] =
{
	{800, 600, 30},
	{800, 600, 60},
	{800, 600, 90},
...
void IndirectDeviceContext::CreateMonitor() {
    ...
    CreateMonitor(0xAA55BB01 + connectedDisplayCount, serialStr.c_str(), dispName.c_str(), containerId);
}

void IndirectDeviceContext::CreateMonitor(uint32_t serial, const char* serialString, const char* displayName,  const GUID& containerId) {
    // ==============================
    ...
    MonitorInfo.MonitorDescription.DataSize = sizeof(edid_base);
   	MonitorInfo.MonitorDescription.pData = generate_edid(serial, serialString, displayName);
